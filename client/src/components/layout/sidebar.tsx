...
export function Sidebar({ posts, onFiltersChange }: SidebarProps) {
  ...
  return (
    <aside className="hidden lg:block w-64 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
